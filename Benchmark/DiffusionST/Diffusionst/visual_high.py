def visual(adata,df_label):
    ...
    sc.pl.embedding(adata, basis="spatial", color="clusters", show=False)

    plt.rcParams["figure.figsize"] = (6, 6)
    sc.pl.embedding(adata, basis="spatial", color="clusters",s=6, show=False, title='Our',save="Hippocampus.pdf")
    plt.axis('off')